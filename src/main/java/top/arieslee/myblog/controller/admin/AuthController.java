...
import top.arieslee.myblog.service.impl.LogServiceImpl;
...
public class AuthController extends BaseController {
    ...
    public ResponseDto login(@RequestParam String username,
        ...
        try {
            ...
            //日志记录
            logServiceImpl.insertLog(LogAction.LOGIN.getAction(), null, userVo.getUid(), IPKit.getIPAddrByRequest(request));
        } catch (Exception e) {
