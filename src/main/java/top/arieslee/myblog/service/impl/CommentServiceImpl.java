...
public class CommentServiceImpl implements ICommentService {
    ...
    public PageInfo<CommentVo> getCommentsWithPage(CommentVoExample commentVoExample, int page, int limit) {
        ...
        List<CommentVo> commentVos = commentVoDao.selectByExampleWithBLOBs(commentVoExample);
    ...
    public void update(CommentVo comments) {
        if (null != comments && null != comments.getCoid()) {
            commentVoDao.updateByPrimaryKeyWithBLOBs(comments);
        }
    }
    ...
    public void delete(Integer coid, Integer cid) {
        ...
        commentVoDao.deleteByPrimaryKey(coid);
    ...
    public CommentVo getCommentById(Integer coid) {
        if (null != coid) {
            return commentVoDao.selectByPrimaryKey(coid);
        }
        return null;
    }
